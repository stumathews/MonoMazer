...
namespace MazerPlatformer
{
    public static class MovingStateStatics
    {
        ...
        public static bool GetSeenInCol(bool eqCol, bool eqRow, IGameWorld gw, Player p, Npc npc, int myRow, int playerRow) => WhenTrue(()=>IsPlayerSeenInCol(eqCol, gw, p, npc)).ToEither().Bind<bool>((success)=>
        {
